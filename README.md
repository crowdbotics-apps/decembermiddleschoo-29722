...
## Project Structure
    ...
    ├── decembermiddleschoo_29722  # Django project configurations
...
1. Clone this repo and `cd decembermiddleschoo_29722`
...
2. Clone this repo and `cd decembermiddleschoo_29722`
